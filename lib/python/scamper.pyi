...
class ScamperDealias:
    ...
    def aliases(self) -> Optional[Tuple[ScamperAddr, ScamperAddr]]: ...
...
class ScamperHost:
    ...
    @property
    def wait_timeout(self) -> datetime.datetime: ...
...
class ScamperTrace:
    ...
    def hops(self) -> Iterator[Optional[ScamperTraceHop]]: ...
...
class ScamperFile:
    ...
    def filter_types(self, *filter_types: Type[ScamperObject]) -> None: ...

    def close(self) -> None: ...
    def read(self) -> Optional[ScamperObject]: ...
