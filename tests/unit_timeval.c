 ...
 *
 * $Id: unit_timeval.c,v 1.12 2026/06/11 07:33:03 mjl Exp $
 *
 *        Matthew Luckie
 *        mjl@luckie.org.nz
 *
...
static int div_tests(void)
{
  sc_div_test_t tests[] = {
    ...
    {3000,  0,          3,      0,     1000},
    {3000,  0,        428, 571428,        7},
    {4293,  999999,  2146, 999999,        2},
    {4294,  967296,  2147, 483648,        2},
    {100000,     0, 14285, 714285,        7},
  };
